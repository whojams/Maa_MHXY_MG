...
6. 发版您的版本
    ...
    git tag v1.7.1-beta.8
    git push origin v1.2.3-beta.1

    git tag  -a v1.7.1 -m "[已有 Mirror酱 CDK？点击前往高速下载](https://mirrorchyan.com/zh/projects?rid=Maa_MHXY_MG)"
    ...
    git -c http.sslVerify=false push origin v1.7.1-beta.8
...
perf:缩短周长战斗间隙时间判断
perf:新增三界奇缘答题部分答案26.1.5
perf:优化520全自动
perf:优化抓鬼兼容性
perf:优化整理背包
perf:手动控制ui和maafw框架版本