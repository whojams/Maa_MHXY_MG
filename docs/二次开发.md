...
6. 发版您的版本
    ...
    git -c http.sslVerify=false push origin v1.8.3-beta.6
    # 删除配置项
...
perf:升级maafw版本5.4.2
perf:回退ui版本
perf:优化mac控制器play cover部分任务关闭
perf:优化宝图任务完成判断，废弃手动选择暂停时间。

refactor:返回按键优化


test:测试ui版本v2.6.5-beta.1